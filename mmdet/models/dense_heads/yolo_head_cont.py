...
class YOLOV3HeadCont(BaseDenseHead, BBoxTestMixin):
    ...
    def _init_layers(self):
        ...
        for i in range(self.num_levels):
            ...
            conv_cont = nn.Conv2d(self.out_channels[i],
                                  self.num_base_priors * self.cont_dim, 1)
    ...
    def loss_single(self, pred_map, cont_map, target_map, neg_map):
        ...
        if self.cont_weight == 0:
            ...
            targets = torch.ones_like(pos_mask, dtype=target_label.dtype) * 8
    ...
    def mse(self, pred, label, **kwargs):
        ...
        loss = F.mse_loss(p_clean, p_aug1, reduction='sum')
