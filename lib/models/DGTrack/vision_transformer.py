...
from lib.models.DGTrack.FADA.reins import Reins
...
from lib.models.DGTrack.utils import combine_tokens, recover_tokens
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.reins = Reins(num_layers=12, embed_dims=192, patch_size=16)
    ...
    def forward_features(self, z, x):
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if i > 1:
                ...
                dynamic_probs = []
                dynamic_probs.append(prob_active.detach())
                mu_p = torch.mean(torch.stack(dynamic_probs))
                beta = 0.7 - 0.2 * mu_p
                beta = torch.clamp(beta, 0.5, 0.9)



                idx, _ = torch.where(prob_active > beta)
...
def resize_pos_embed(
    ...
    *DEPRECATED* This function is being deprecated in favour of resample_abs_pos_embed
    ...
    Adapted from:
        https://github.com/google-research/vision_transformer/blob/00883dd691c63a6830751563748663526e811cee/vit_jax/checkpoint.py
    """
