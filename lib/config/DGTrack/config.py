...
"""
Add default config for DGTrack.
"""
cfg = edict()

cfg.MODEL = edict()
cfg.MODEL.PRETRAIN_FILE = "deit_tiny_patch16_224.pth"
...
cfg.MODEL.BACKBONE.TYPE = "deit_tiny_patch16_224"
...
cfg.TRAIN.CE_START_EPOCH = 5
cfg.TRAIN.CE_WARM_EPOCH = 8
