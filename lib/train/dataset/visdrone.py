...
class VISDRONE(BaseVideoDataset):
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        super().__init__('VISDRONE', root, image_loader)
        ...
        if split is not None:
            ...
            if split == 'daylight':
                file_path = os.path.join(ltr_path, 'data_specs', 'visdrone_daylight_split.txt')

            elif split == 'daylight_aug1':
                file_path = os.path.join(ltr_path, 'data_specs', 'visdrone_daylight_aug1_split.txt')

            elif split == 'daylight_aug2':
                file_path = os.path.join(ltr_path, 'data_specs', 'visdrone_daylight_aug2_split.txt')
    ...
    def _read_meta(self, seq_path):
        try:
            ...
            object_meta = OrderedDict({'object_class_name': 'object',
                                       'motion_class': None,
                                       'major_class':None,
                                       'root_class': None,
                                       'motion_adverb':  None})
